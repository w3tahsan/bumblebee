						...
						<div class="card">
                            ...
                            <div class="auth-form-wrapper px-4 py-5">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" name="name" class="form-control @error('name') is-invalid @enderror" id="exampleInputUsername1" value="{{ old('name') }}" autocomplete="Username" placeholder="Username">
                                    @error('name')
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="email" name="email" class="form-control @error('email') is-invalid @enderror" id="exampleInputEmail1" value="{{ old('email') }}" placeholder="Email">
                                    @error('email')
                                        <span class="invalid-feedback" role="alert">
                                            <strong>{{ $message }}</strong>
                                        </span>
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="password" name="password_confirmation" id="exampleInputPassword1" autocomplete="current-password" class="form-control" placeholder="Confirm Password">
